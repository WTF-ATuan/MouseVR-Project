...
namespace Actor.Editor{
	public class EnvironmentCue : OdinEditorWindow{
		...
		[SerializeField] private List<Material> switchtMaterials = new List<Material>();
		...
		protected override void OnGUI(){
			...
			_meshRenderer = (MeshRenderer)EditorGUILayout.ObjectField(_meshRenderer, typeof(MeshRenderer), true);
		...
		private void DashboardDownPos(){
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.PropertyField(currentMaterialSerializedObject, true, GUILayout.Width(200));
			EditorGUILayout.PropertyField(switchtMaterialsSerializedObject, true, GUILayout.Width(200));
			EditorGUILayout.EndHorizontal();
